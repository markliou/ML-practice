...
OUTPUT_DIR=`pwd`/nmt_data/wmt16_de_en
...
# axel -n 5 -q -o ${OUTPUT_DIR_DATA}/europarl-v7-de-en.tgz \
  # http://www.statmt.org/europarl/v7/de-en.tgz

# echo "Downloading Common Crawl corpus. This may take a while..."
# axel -n 5 -q -o ${OUTPUT_DIR_DATA}/common-crawl.tgz \
  # http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz

# echo "Downloading News Commentary v11. This may take a while..."
# axel -n 5 -q -o ${OUTPUT_DIR_DATA}/nc-v11.tgz \
  # http://data.statmt.org/wmt16/translation-task/training-parallel-nc-v11.tgz

# echo "Downloading dev/test sets"
# axel -n 5 -q -o  ${OUTPUT_DIR_DATA}/dev.tgz \
  # http://data.statmt.org/wmt16/translation-task/dev.tgz
# axel -n 5 -q -o  ${OUTPUT_DIR_DATA}/test.tgz \
...
for merge_ops in 32000; do
  echo "Learning BPE with merge_ops=${merge_ops}. Thisq may take a while..."
