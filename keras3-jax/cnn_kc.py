...
def cnn():
    ...
    c1 = k.layers.Conv2D(32, (3, 3), padding="same",
                         activation=k.activations.elu)(x)
...
def main():
    ...
    opt = k.optimizers.AdamW(global_clipnorm=1.0)
    ...
    def compute_loss(trainableVars, nonTrainableVars, img, lab):
        ...
        loss = k.losses.CategoricalCrossentropy(
            from_logits=False)(lab, predOutput)
    ...
    def trainer(state, img, lab):
        ...
        sTrainableVars, sOptVars = opt.stateless_apply(
            grads, sTrainableVars, sOptVars)
